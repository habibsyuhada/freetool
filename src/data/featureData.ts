...
import { IconCoin, IconCode, IconFingerprint, IconChartPie3, IconBook, IconTools } from "@tabler/icons-react";
...
export const featureData = [
  ...
  {  
    ...
    description: "Create interactive documents effortlessly. Enhance your presentations and reports with engaging content.",  
    link: "/interactive-document-generator",  
  },  
  {
    icon: IconCode,
